      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 px-4 sm:px-8 py-20 max-w-7xl mx-auto font-sans text-brand-text">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex gap-4 mt-2">
            <a href="#" className="text-brand-text-muted hover:text-brand-yellow hover:-translate-y-1 active:scale-95 transition-all"><Globe className="w-5 h-5" /></a>
            <a href="#" className="text-brand-text-muted hover:text-brand-yellow hover:-translate-y-1 active:scale-95 transition-all"><Network className="w-5 h-5" /></a>
            <a href="#" className="text-brand-text-muted hover:text-brand-yellow hover:-translate-y-1 active:scale-95 transition-all"><Share2 className="w-5 h-5" /></a>
          </div>
        </div>
